<template>
  <div class="shop_container">
    <ul class="shop_list" v-if="$store.state.shops.length">
      <li class="shop_li border-1px" v-for="(shop,index) in $store.state.shops" :key = 'index' @click="$router.push('/shop')">
        <a>
          <div class="shop_left">
          ...
          <div class="shop_right">
            ...
            <section class="shop_distance">
              <p class="shop_delivery_msg">
                <span>¥{{shop.delivery_mode.float_minimum_order_amount}}起送</span>
                <span class="segmentation">/</span>
                <span>配送费约¥{{shop.delivery_mode.float_delivery_fee}}</span>
              </p>
            </section>
          </div>
        </a>
